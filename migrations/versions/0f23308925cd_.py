...
Revision ID: 0f23308925cd
Revises: 
Create Date: 2020-09-16 16:00:43.716370
...
def upgrade():
    ...
    sa.Column('admin_id', sa.String(length=50), nullable=True, unique=True),
    sa.Column('admin_pass', sa.String(length=50), nullable=True, unique=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('admin_id'),
    sa.UniqueConstraint('admin_pass')
    )
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('doc_id', sa.String(length=200), nullable=True,unique=True),
    sa.Column('doc_pass', sa.String(length=10), nullable=True,unique=True),
    ...
    sa.Column('user_id', sa.String(length=100), nullable=True,unique=True),
